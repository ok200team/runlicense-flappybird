...
export interface InitOutput {
    ...
    readonly wasm_bindgen__closure__destroy__h39189e1eae65c9c1: (a: number, b: number) => void;
    readonly wasm_bindgen__closure__destroy__h8fc8786b4abf673e: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__hf60ede254a8638fa: (a: number, b: number, c: any) => [number, number];
    readonly wasm_bindgen__convert__closures_____invoke__h91f7fcfcf07db1dd: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h91f7fcfcf07db1dd_2: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h91f7fcfcf07db1dd_3: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__hb26893cad6ad8ded: (a: number, b: number) => void;
