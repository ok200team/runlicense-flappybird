...
export interface InitOutput {
    ...
    readonly wasm_bindgen__closure__destroy__h21e81fc10ae400db: (a: number, b: number) => void;
    readonly wasm_bindgen__closure__destroy__hf988b3662be58bc2: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__hf60ede254a8638fa: (a: number, b: number, c: any) => [number, number];
    readonly wasm_bindgen__convert__closures_____invoke__h5055b0d3c8074d1b: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h5055b0d3c8074d1b_2: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h5055b0d3c8074d1b_3: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h5492261e7c931f01: (a: number, b: number) => void;
