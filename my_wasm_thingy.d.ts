...
export interface InitOutput {
    ...
    readonly wasm_bindgen__closure__destroy__h5c17103ffb908a6d: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h26e23bd7929d5711: (a: number, b: number, c: any) => [number, number];
    readonly wasm_bindgen__convert__closures_____invoke__h3888af13b9e6f504: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h3888af13b9e6f504_3: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h3888af13b9e6f504_4: (a: number, b: number, c: any) => void;
