...
export interface InitOutput {
    ...
    readonly wasm_bindgen__closure__destroy__h0b99ac305cd2e657: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h26e23bd7929d5711: (a: number, b: number, c: any) => [number, number];
    readonly wasm_bindgen__convert__closures_____invoke__h0522fbcd63584219: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h0522fbcd63584219_3: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h0522fbcd63584219_4: (a: number, b: number, c: any) => void;
