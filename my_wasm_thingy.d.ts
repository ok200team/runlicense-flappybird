...
export interface InitOutput {
    ...
    readonly wasm_bindgen__closure__destroy__h0956d6646d5d6af4: (a: number, b: number) => void;
    readonly wasm_bindgen__closure__destroy__haec79b689bf1b739: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__hf60ede254a8638fa: (a: number, b: number, c: any) => [number, number];
    readonly wasm_bindgen__convert__closures_____invoke__h56b796f70ba93a71: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h56b796f70ba93a71_2: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h56b796f70ba93a71_3: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__hf0aa066da7a27c27: (a: number, b: number) => void;
